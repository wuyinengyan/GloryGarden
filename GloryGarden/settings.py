"""
Django settings for GloryGarden project.
...
SECRET_KEY = '(%5k9z7cv0)m3z5vvr-k9j@1hpgvt@2(mqmhtd9a21dfb^pv35'
...
ROOT_URLCONF = 'GloryGarden.urls'
X_FRAME_OPTIONS = 'SAMEORIGIN'
TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        # ^LHJNote：templates添加dirs 2020年8月11日11$  作为一个list处理，在后方添加；
        'DIRS': [os.path.join(BASE_DIR, 'templates'), os.path.join(BASE_DIR, 'gujianonline/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'GloryGarden.wsgi.application'
